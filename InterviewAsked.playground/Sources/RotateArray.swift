...
public class P1 {
    ...
    public static func rotateArrayLeft(array: [Int],at: Int)->[Int] {
        let r = at % array.count
        if r == 0 {
            return array
        }
    ...
    public static func rotateArrayLetByDropFirstPrefix(array: [Int],at: Int)->[Int] {
        let r = at % array.count
    ...
    */
    ...
    public static  func rotateArrayRight(ar: [Int], at: Int) -> [Int] {
    ...
    public static func rotateArrayRightByDropFirstPrefix(array: [Int],at: Int)->[Int] {
        let r = at % array.count
...
//    print(rotateRightArray(ar: arr2, at: 7)) // Output: [40, 50, 10, 20, 30]
   ...
   /// ✔ Large at values → Uses modulo to optimize performance.
    ...
    static public func run(){
        ...
        let arr1 = [1, 2, 3, 4, 5]
        print(P1.rotateArrayRight(ar: arr1, at: 2)) // Output: [4, 5, 1, 2, 3]

        let arr2 = [10, 20, 30, 40, 50]
        print(P1.rotateArrayRightByDropFirstPrefix(array: arr2, at: 7))
    }
}
